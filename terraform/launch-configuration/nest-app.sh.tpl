...
sudo aws s3 sync s3://cea-project-dynamic-app/nest-app/ /var/www/html
...
sudo aws s3 cp s3://cea-project-dynamic-app/nest-app/AppServiceProvider.php /var/www/html/app/Providers/AppServiceProvider.php
